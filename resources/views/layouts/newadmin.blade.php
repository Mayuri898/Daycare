...
<div class="wrapper">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">I want to change my username and Password</p>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">DayCare</span>
    </a>
...
?>
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="{{ route('admin.noticeboard.index')}}" class="nav-link
             @if($segment=='noticeboard')
            active
            @endif">
              <i class="nav-icon fas fa-calendar-week"></i>
              <p>
